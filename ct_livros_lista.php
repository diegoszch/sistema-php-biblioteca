...
<table id="mytable" cellspacing="0">    
    ...
    <tr>
        ...
        <td <?=$class_alt;?>><a class="botao" href="index.php?area=livros&acao=alterar&id=<?=$row["id"];?>">Alterar</a></td>
        <td <?=$class_alt;?>><a href="#" class="botao" onclick="excluiReg(<?=$row["id"];?>)">Excluir</a></td>
    </tr>
    <form name="form<?=$row["id"];?>" id="form<?=$row["id"];?>" method="POST" action="ct_livros_xp.php">
...
?>
<br />
<div><a class="botao" href="index.php?area=livros&acao=inserir">Inserir</a></div>
